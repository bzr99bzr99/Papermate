...
1. 打开“模型设置”，选择 DeepSeek 或智谱 GLM，填写 API Key 并验证连接。
...
| ![API 设置 1](截图/api设置1.png) | 模型设置：填写 DeepSeek 或智谱 GLM API Key，并验证连接。 |
| ![API 设置 2](截图/api设置2.png) | 设置面板其余区域：阅读主题与完整 JSON 备份管理。 |
